  ...
  return (
    <>
      <section className="bg-gray-900 text-white">
        <div className="px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8 grid justify-items-center">
          ...
          <div className="mt-8 grid grid-cols-1 gap-8 md:mt-16 md:grid-cols-2 md:gap-12 lg:grid-cols-3">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-lg font-bold">Buy Tickets</h2>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-lg font-bold">List Tickets</h2>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-lg font-bold">Trade Tickets.</h2>
